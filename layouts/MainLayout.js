...
import AirConditionTabs from '../components/AirConditionTabs'
...
export default function MainLayout({ child }) {
    ...
    const userImage = "BASE64 ENCODED IMAGE"
                    ...
                    <div className="flex flex-shrink-0 border-t border-gray-800 p-4">
                        <a href="#" className="group block w-full flex-shrink-0 group">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3">
                                    <p className="text-sm font-medium text-gray-300 group-hover:text-gray-200">Alican Erden</p>
                                    <p className="text-xs font-medium text-gray-500 group-hover:text-gray-400">View profile</p>
                                </div>
                            </div>
                        </a>
                    </div>
